...
func TestAccOrgServiceAccountRS_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{ // TODO: verify updates and import in case of resources
			//			{
			//				Config: orgServiceAccountConfig(),
			//				Check:  orgServiceAccountAttributeChecks(),
			//			},
			//          {
			//				Config: orgServiceAccountConfig(),
			//				Check:  orgServiceAccountAttributeChecks(),
			...
			//				ImportStateIdFunc: checkOrgServiceAccountImportStateIDFunc,
			//				ImportState:       true,
